...
function lunch()
{
    ...
    if [ "$1" ]; then
        ...
        print_lunch_menu
        echo "Which would you like? [aosp_cf_x86_64_phone-ap4a-eng]"
        echo -n "Pick from common choices above (e.g. 13) or specify your own (e.g. aosp_barbet-ap4a-eng): "
        read answer
        used_lunch_menu=1
    fi
    ...
    if [ -z "$answer" ]
    then
        selection=aosp_cf_x86_64_phone-ap4a-eng
